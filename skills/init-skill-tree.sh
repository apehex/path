...
# cyber-security
mkdir -p ./technical/computing/cyber-security/blue/
...
touch ./technical/computing/cyber-security/blue/social/anti-spam

# pentesting
mkdir -p ./technical/computing/cyber-security/red/
touch ./technical/computing/cyber-security/red/cryptography/cracking # bruteforce, hash
