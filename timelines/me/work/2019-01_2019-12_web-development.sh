...
echo "|" >> ./technical/computing/languages/data-driven/yaml
echo "|" >> ./technical/computing/languages/declarative/css
echo "|" >> ./technical/computing/languages/declarative/html
echo "|" >> ./technical/computing/languages/object-oriented/ruby
